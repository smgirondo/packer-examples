...
variable "install_boot_ks" {
  type    = string
  default = "ks"
  description = "RHEL Anaconda Kickstart Boot Command"
}

variable "install_boot_method" {
  type    = string
  default = "text"
  description = "RHEL Anaconda Install Boot Method"
}

variable "install_boot_options" {
  type    = string
  default = ""
  description = "RHEL Anaconda Install Boot Options"
}
...
variable "iso_external_mirror" {
  type    = string
  default = "ftp.rediris.es"
}

variable "iso_external_mirror_path" {
  type    = string
  default = "mirror/CentOS/7.9.2009/isos/x86_64"
}
...
variable "package_external_mirror_path" {
  type    = string
  default = "mirror/CentOS/7/os/x86_64"
}
...
variable "use_default_display" {
  type    = bool
  default = true
  description = "User QEMU default display"
}

variable "vm_name" {
  type    = string
  default = "centos7-bios"
  description = "VM Name"
}

locals {
  boot_command     = [
    "<tab> ${var.install_boot_method}<wait> ",
